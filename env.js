 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.expo-owner-template.staging
 */

const BUNDLE_ID = 'com.expo-owner-template'; // ios bundle id
const PACKAGE = 'com.expo-owner-template'; // android package name
const NAME = 'expo-owner-template'; // app name
